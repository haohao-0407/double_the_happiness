...
public class double_the_happiness
{
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("double_the_happiness", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.double_the_happiness")) //The language key for the title of your CreativeModeTab
